    ...
    <>
      <div>
        <div className="relative overflow-hidden bg-zinc-50">
          <div className="page-fade-in z-20 h-[100dvh] w-full bg-[url('/Stock/man-getting-botox-mobile.jpg')] bg-cover bg-fixed bg-center bg-no-repeat lg:bg-[url('/Stock/man-getting-botox.jpg')]">
            <div
