    ...
    <>
      <div className={`z-10 mb-[100vh]`}>
        <div className="relative z-50 overflow-hidden bg-zinc-50">
          <div className="page-fade-in z-20 h-[100dvh] w-screen bg-[url('/Stock/man-getting-botox-mobile.jpg')] bg-cover bg-fixed bg-no-repeat md:bg-[url('/Stock/man-getting-botox.jpg')] md:bg-center">
            <div
